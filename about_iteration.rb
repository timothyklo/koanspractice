...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # BEGINS WITH (INITIAL) AND APPLIES THE BLOCK TO EACH ITEM IN THE ARRAY
  end
  ...
  #
  #  FILE.OPEN USED WITH A BLOCK PASSES FILE AS ARGUMENT AND CLOSES FILE WHEN BLOCK ENDS
